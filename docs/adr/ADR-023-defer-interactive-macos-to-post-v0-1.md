...
- **File paths** — MakieViews is developed on Windows and CI is Linux; APFS case-sensitivity and macOS-specific path handling are unreached.
...
- **Cost**: free for public repos within GHA limits. XerxesZorgon/MakieViews.jl is public.

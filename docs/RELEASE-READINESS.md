...
**Date**: 2026-08-28
**Companion**: [ADR-022](adr/ADR-022-v0-1-ships-repl-driven.md) (v0.1.0 scope); [ADR-020](adr/ADR-020-defer-fps-measurement-to-m11.md) updated 2026-08-28 (FPS measurement pass → v0.2)
...
- **README ✓** — reconciled 2026-08-28 (ADR-022 + Framing-A REPL Quickstart, verified against the actual public API). Accurately describes the v0.1 shipping surface; v0.2 roadmap section captures deferred work.
- **CHANGELOG `[0.1.0]` ✓** — scoped to the REPL-driven core (cross-references ADR-022); Known-limitations lists Bug F, `.mvz` data round-trip, and GUI deferral.
